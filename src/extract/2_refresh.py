...
Usage:
    python 2_refresh.py              # Crawl all agencies
    python 2_refresh.py <folder>     # Crawl specific agency by folder name

Examples:
    python 2_refresh.py                    # Crawl all agencies
    python 2_refresh.py agriculture        # Crawl only Agriculture department
    python 2_refresh.py human-resources    # Crawl only HR
"""
